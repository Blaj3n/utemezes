...
# def masodperc(perc:int, mp:int)->int: # ez egy szűrés, hogy mindenképpen intet várunk bemenetre és kimenetre is.
#     return (perc * 60) + mp
#
# print(masodperc(5, 40))

def masodperc(perc:int, mp:int):
    return (perc * 60) + mp  # return == visszatérés
